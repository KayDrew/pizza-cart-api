...
const url="https://pizza-api.projectcodex.net/api/pizza-cart/tM7QV2T6lD/get";
...
axios.post('https://pizza-api.projectcodex.net/api/pizzas/api/pizza-cart/add',{"cart_code":"tM7QV2T6lD","pizza_id":4}).then(
